                    	...
                    	<tr>
                            ...
                            <td>
                                <?php 
                                    if($data['user_photo']!=''){
                                ?>
                                    <img width="50" height="50" src="uploads/<?= $data['user_photo']; ?>" alt="Photo"/>
                                <?php 
                                    }else{
                                ?>
                                    <img width="50" height="50" src="images/avatar.png" alt="Photo"/>
...
<?php 
    get_footer();
        ...
        echo "Access Denied! You have no permission visit this content!";
    }
?> 